...
import { formatDateString, setPath } from './utils.js';
 ...
 *
 * @param fields - An object containing field atoms to
 ...
 *
 * @param formAtom - The atom that stores the form state.
 ...
 *
 * @param formAtom - The atom that stores the form data.
 * @param options - Options to pass to the underlying `useAtomValue`
 *  and `useSetAtom` hooks.
 ...
 *
 * @param config - The initial state and configuration of the field.
 * @returns A FieldAtom.
 */
 ...
 * field atom state.
 *
 * @param fieldAtom - The atom that stores the field's state.
 * @param options - Options to pass to the underlying `useAtomValue`
 *  and `useSetAtom` hooks.
